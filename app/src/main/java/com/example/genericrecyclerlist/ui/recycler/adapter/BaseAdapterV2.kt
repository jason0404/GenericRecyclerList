...
//
//abstract class BaseAdapterV2<ITEM, VH: BaseViewHolder<ITEM, *>>(
//    private val diffItemUtilCallback: DiffUtil.ItemCallback<ITEM> = DiffUtil.ItemCallback<ITEM>()
//): ListAdapter<ITEM, VH>(diffItemUtilCallback) {
//    var diffResult: DiffResult? = null
//    private var hashMap: ConcurrentHashMap<String, Int>? = null
